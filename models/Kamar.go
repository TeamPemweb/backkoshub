...
type Kamar struct {
	...
	KodeKamar   string    `gorm:"type:varchar(10);unique;not null"` // Kode unik untuk join penghuni
	Status      string    `gorm:"type:varchar(20);default:'kosong'"` // "kosong" atau "terisi"
	PenghuniID  *uint     `gorm:"default:null"` // Mengarah ke UserID Penghuni, bisa null kalau kosong
